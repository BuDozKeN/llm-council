...
- **Database:** Supabase (PostgreSQL) - being implemented for multi-tenant data
...
├── context.md           # Business context (534 lines)
└── departments/
    └── technology/
        └── roles/
            └── cto.md   # This file - role context
```
...
### Data Storage (Target - Supabase)

Migration in progress to PostgreSQL with these tables:
- `companies` - Multi-tenant organizations
- `departments` - Groups roles by department
- `roles` - AI personas with system_prompt text
